...
INTERFACE
    VAR_INPUT CONSTANT
        Buffer : POINTER TO STRING[None] := 0; (*Externally allocated buffer. Must be in format ARRAY[0..N]. ! Block doesn't check for Null pointer*)
    ...
    END_VAR
END_INTERFACE
FUNCTION_BLOCK FIFO_FWFT_String:
