...
## Documentation for Function block FIFO_C_64b  

Circular FIFO buffer of generic type that works with 64 bit values (based on LWORD). Allows Enqueuing when there is a free space in front of the tail. Strings and data structures are not supported.  
