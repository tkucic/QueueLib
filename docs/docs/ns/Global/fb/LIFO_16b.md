...
## Documentation for Function block LIFO_16b  

LIFO / Stack buffer of generic type that works with 16 bit values (based on WORD). Pushing places new value on top of the stack and poping removes the element from the top. Strings and data structures are not supported.  
...
| Direction | Name | Type | Attribute | Initial Value | Documentation |
| --------- | ---- | ---- | --------- | ------------- | ------------- |
| VAR_INPUT | Value | WORD |  |  | Value to add to the stack |  
