...
## Documentation for Function block FIFO_FWFT_Dint  
...
INTERFACE
    VAR_INPUT CONSTANT
        Buffer : POINTER TO DINT := 0; (*Externally allocated buffer. Must be in format ARRAY[0..N]. ! Block doesn't check for Null pointer*)
